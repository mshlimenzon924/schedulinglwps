...
scheduler current_scheduler = &FirstComeFirstServe; // set up round robin
...
void lwp_exit(int exitval) {
    ...
    //printf("TID %d EXIT %d STATUS %d\n", current_thread->tid, exitval, current_thread->status);
